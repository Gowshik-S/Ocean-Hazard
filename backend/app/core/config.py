...
class Settings(BaseSettings):
    ...
    # Database
    DATABASE_URL: str = "postgresql://postgres:password@localhost:5432/ocean_hazard_db"
    DATABASE_URL_LOCAL: str = "postgresql://postgres:password@localhost:5432/ocean_hazard_db"
